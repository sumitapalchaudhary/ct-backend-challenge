...
export class FlightService {
    ...
    getCombinedFlightsWithoutDuplicates(): Observable<FlightServiceDTO> 
    {
        ...
        let flightList1: Observable<FlightServiceDTO> = this.dataService.callFlightDataService('https://discovery-stub.comtravo.com/source1');
        let flightList2: Observable<FlightServiceDTO> = this.dataService.callFlightDataService('https://discovery-stub.comtravo.com/source2');
